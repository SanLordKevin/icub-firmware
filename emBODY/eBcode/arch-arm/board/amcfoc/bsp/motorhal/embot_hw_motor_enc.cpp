...
//    embot::core::print( "Enc Resolution: " + std::to_string(_enc_internals._items[motorIndex].mode.resolution)+
//        " Enc Conversionfactor: "+ std::to_string(_enc_internals._items[motorIndex].conversionfactor) 
//    );
